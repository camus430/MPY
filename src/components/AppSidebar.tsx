import { Home, TrendingUp, Users, Clock, ThumbsUp, PlaySquare, UserCheck, ChevronDown, Download, Plus } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Plus, label: "Ajouter média", path: "/add-media" },
